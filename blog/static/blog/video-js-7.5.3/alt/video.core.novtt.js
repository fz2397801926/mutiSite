...
(function (global, factory) {
  ...
  } // jsdocs for instance/publicStatic members added above
  ...
  function (_Component) {
    ...
    */
    ...
    Tech.registerTech = function registerTech(name, tech) {
      ...
      if (!Tech.canPlayType) {
        throw new Error('Techs must have a publicStatic canPlayType method on them');
      }

      if (!Tech.canPlaySource) {
        throw new Error('Techs must have a publicStatic canPlaySource method on them');
      }
